      ...
      <Slide>
        <Row>
          ...
          <Col md={6}>
            <div className="col-content">
              <h5>
                <span className="green">CAT-ASSESSMENT BPKP</span>
              </h5>
              <p>
                Create a website using assessment functionality provides a
                platform for conducting various types of assessments,
                evaluations, or tests. It enables users to create and administer
                assessments, as well as collect and analyze the results.
              </p>
              <p>
                Technology : <span className="green">React Js, Laravel</span>{" "}
                <br />
        ...
        <Row>
          ...
          <Col md={6}>
            <div className="col-content">
              <h5>
                <span className="green">VORTIGERN STORE</span>
              </h5>
              <p>
                Build my own simple app to help make in-game item purchases.
                This application is still in the early stages of development
              </p>
              <p>
              ...
              <Button
                ...
                href="https://github.com/ArisFrsy/vortigern-store"
              >
                <span className="green">
                  <i className="fab fa-github"></i>
                </span>{" "}
        ...
        <Row>
          ...
          <Col md={6}>
            <div className="col-content">
              <h5>
                <span className="green">E-FORM MNK</span>
              </h5>
              <p>
                Developing an existing information system. Making feature
                improvements, adding features, and optimizing data management
              </p>
              <p>
                Technology : <span className="green">Code Igniter 3</span>{" "}
                <br />
                Type : <span className="green">Job projects</span>
              </p>
              <Button className="btn-bottom" onClick={() => showAlert()}>
        ...
        {/* <Row>
          ...
          <Col md={6}>
            <div className="col-content">
              <h5>
                <span className="green">CONTACT MANAGEMENT</span>
              </h5>
              ...
              <Button
                className="btn-bottom"
                href="https://github.com/ArisFrsy/Vuejs-contact-management"
              >
                <span className="green">
                  <i className="fab fa-github"></i>
                </span>{" "}
        ...
        <Col className="m-4">
          ...
          <table class="table table-dark">
            ...
            <tbody>
              <tr>
                <th scope="row">1</th>
                <td>Learning Manajement System (LMS)</td>
                <td>PLN</td>
              ...
              <tr>
                <th scope="row">4</th>
                <td>UTT-ASSESSMENT BPKP</td>
                <td>BPKP</td>
                <td>Laravel, React.js</td>
              </tr>
              <tr>
                <th scope="row">5</th>
                <td>MONITORING-ASSESSMENT BPKP</td>
                <td>BPKP</td>
                <td>Laravel, React.js</td>
              </tr>
            </tbody>
